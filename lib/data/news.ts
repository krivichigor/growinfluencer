...
export const newsArticles: NewsArticle[] = [
  {
    ...
    "metaDesc": "Final viewership for StarLadder Budapest Major 2025 (CS2): 1.54M peak viewers, 71.1M hours watched, 516.9K average. Vitality defeat FaZe 3–1. Why stadium Majors matter beyond esports + 2024 comparisons.",
    ...
    "excerpt": "The StarLadder Budapest Major 2025 ended with a statement: Vitality beat FaZe 3–1, and the broadcast peaked at 1 544 419 viewers during the final. Here are the final numbers, what pushed them so high, and why a CS2 Major in a 20,000-seat arena matters far beyond esports.",
    ...
    "overview": "The StarLadder Budapest Major 2025 is complete (ended 21:00 GMT+0). Final Esports Charts snapshot: Peak Viewers 1 544 419 (20:05 during the Grand Final), 71 139 208 Hours Watched, 518 319 Average Viewers, and 137h 5m Airtime. Vitality beat FaZe 3–1 in the final. Some metrics may still be slightly adjusted as post-event tracking settles — we’ll monitor the Esports Charts page.",
    "didYouKnow": [
